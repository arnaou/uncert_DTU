...
<html lang="en" data-content_root="../../../../../" >
  ...
  <head>
    ...
    <title>Notebooks with MyST Markdown &#8212; Uncertainty and Sensitivity Analysis of Model Output in Engineering Applications</title>
...
<a class="navbar-brand logo" href="../../../../../intro.html">
    ...
    <img src="../../../../../_static/logo.png" class="logo__image only-light" alt="Uncertainty and Sensitivity Analysis of Model Output in Engineering Applications - Home"/>
    <script>document.write(`<img src="../../../../../_static/logo.png" class="logo__image only-dark" alt="Uncertainty and Sensitivity Analysis of Model Output in Engineering Applications - Home"/>`);</script>
        ...
        <ul class="nav bd-sidenav bd-sidenav__home-link">
            <li class="toctree-l1">
                <a class="reference internal" href="../../../../../intro.html">
                    Welcome to Uncertainty and Sensitivity Analysis of Model Output in Engineering Applications 👋👋👋
                </a>
            </li>
        </ul>
...
<li class="toctree-l1"><a class="reference internal" href="../../../../../02_Introduction_Differential_Equations.html">2. Introduction to differential Equations ⏳</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../03_Introduction_Parameter_Fitting.html">3. Introduction to Parameter Fitting 🔧</a></li>
</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">Case study</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../04_Introduction_Case_Study.html">4. Introduction to Case Study 📒</a></li>
</ul>
<p aria-level="2" class="caption" role="heading"><span class="caption-text">Uncertainty Analysis</span></p>
<ul class="nav bd-sidenav">
<li class="toctree-l1"><a class="reference internal" href="../../../../../05_Frequentist_Approaches.html">5. Frequentist Approaches 📅</a></li>
<li class="toctree-l1"><a class="reference internal" href="../../../../../06_Bayesian_Approaches.html">6. Bayesian Approaches ➰</a></li>
</ul>
...
<div class="dropdown dropdown-launch-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="https://staging.datahub.berkeley.edu/hub/user-redirect/git-pull?repo=https%3A//github.com/arnaou/uncert_DTU&urlpath=tree/uncert_DTU/docs/.conda/Lib/site-packages/jupyter_book/book_template/markdown-notebooks.md&branch=master" target="_blank"
...
<span class="btn__text-container">JupyterHub</span>
      ...
      <li><a href="https://colab.research.google.com/github/arnaou/uncert_DTU/blob/master/docs/.conda/Lib/site-packages/jupyter_book/book_template/markdown-notebooks.md" target="_blank"
   class="btn btn-sm dropdown-item"
...
<div class="dropdown dropdown-source-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="https://github.com/arnaou/uncert_DTU" target="_blank"
...
<span class="btn__text-container">Repository</span>
      ...
      <li><a href="https://github.com/arnaou/uncert_DTU/issues/new?title=Issue%20on%20page%20%2F.conda/Lib/site-packages/jupyter_book/book_template/markdown-notebooks.html&body=Your%20issue%20content%20here." target="_blank"
...
<div class="dropdown dropdown-download-buttons">
  ...
  <ul class="dropdown-menu">
      ...
      <li><a href="../../../../../_sources/.conda/Lib/site-packages/jupyter_book/book_template/markdown-notebooks.ipynb" target="_blank"
...
By Adem R.N. Aouichaoui and Gürkan Sin
</p>
